...
def handle_uploaded_file(request, f):
    ...
    try:
        ...
        image.save(FILE_SAVE_PATH + user.name, image.format)
        ...
        avatar.image_url = FILE_URL_PATH + user.email + '/' + user.name
        avatar.save()
        response["message"] = "Success"
        response["image_url"] = FILE_URL_PATH + user.email + '/' + user.name
